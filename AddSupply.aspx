<%@ Page Language="C#" AutoEventWireup="true" Inherits="AddSupply" Codebehind="AddSupply.aspx.cs" %>
...
<table border="1" align="center" cellpadding="5" cellspacing="1" bgcolor="#eeeeee" style="width:100%">
  ...
  <tr bgcolor="#a4a4a4">
    <td colspan="2" style="height: 10px"><div align="center">
        <strong><span class="style3">供货单位添加</span></strong>（<span class="STYLE1">带*号的信息必需填写</span>）</div></td>
  </tr>
  <tr>
