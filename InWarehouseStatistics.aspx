<%@ Page Language="C#" AutoEventWireup="true" Inherits="InWarehouseStatistics" Codebehind="InWarehouseStatistics.aspx.cs" %>
...
<table width="100%" border="1" align="center" cellpadding="5" cellspacing="1"  >
     <tr>
    <td height="10"  bgcolor="blue" style="width: 100%"><div align="center" 
            class="style1"><strong>产品入库管理</strong></div></td>
  </tr>
</table>
    ...
    <tr>
      ...
      OnPageIndexChanging="GridView1_PageIndexChanging1" 
              ...
              <Columns>
                  ...
                  <asp:BoundField DataField="Number" HeaderText="入库编号" />
                  <asp:BoundField DataField="ProductName" HeaderText="产品名称" />
                  <asp:BoundField DataField="Count" HeaderText="产品入库数量" />
                  <asp:BoundField DataField="InPrice" HeaderText="产品单价" />
          ...
          <HeaderStyle BackColor="#990000" Font-Bold="True" ForeColor="White" HorizontalAlign =Center  Height ="29" />
...
<table border="1" align="center" cellpadding="3" cellspacing="1" style="width: 100%">
    ...
    <tr align="left" >
        <td bgcolor="#ffffff" colspan="5" style="width: 80%; height: 21px;" 
            class="style2">
            请输入统计时间:<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>&nbsp;&nbsp; <asp:Button ID="Button2"
                runat="server" Text="产品入库年度统计" OnClick="Button2_Click" />
            &nbsp;&nbsp;
            </td>
    </tr>
