<%@ Page Language="C#" AutoEventWireup="true" Inherits="ManagerReceivingUnit" Codebehind="ManagerReceivingUnit.aspx.cs" %>
...
<table width="100%" border="1" align="center" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
    ...
    <td height="10" bgcolor="blue" style="width: 59%"><div align="center" 
            class="style1"><strong>管理收货单位</strong></div></td>
  </tr>
</table>
<table width="100%" border="1" align="center" cellpadding="5" cellspacing="0">
    <tr>
      ...
      OnPageIndexChanging="GridView1_PageIndexChanging1" 
              ...
              PageSize="8" HorizontalAlign="Left" AllowPaging="True" DataKeyNames ="RId" 
              ForeColor="#333333" GridLines="None">
              <Columns>
                  <asp:BoundField DataField="RId" Visible="False" />
                  <asp:BoundField DataField="Number" HeaderText="收货单位编号" />
                  <asp:BoundField DataField="Name" HeaderText="收货单位名称" />
                  <asp:BoundField DataField="Address" HeaderText="收货单位地址" />
                  <asp:BoundField DataField="tel" HeaderText="收货联系电话" />
                  <asp:BoundField DataField="person" HeaderText="收货单位联系人" />
                  <asp:HyperLinkField DataNavigateUrlFields="RId" DataNavigateUrlFormatString="UpdateUnits.aspx?ID={0}"
