<%@ Page Language="C#" AutoEventWireup="true" Inherits="ManagerWarehouse" Codebehind="ManagerWarehouse.aspx.cs" %>
...
<table width="100%" border="1" align="center" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
    ...
    <td height="10" bgcolor="blue" style="width: 59%; color: #FFFFFF;">
        <div align="center" class="style1"><strong>仓库管理</strong></div></td>
  </tr>
</table>
<table width="100%" border="1" align="center" cellpadding="5" cellspacing="0">
    <tr>
      ...
      OnPageIndexChanging="GridView1_PageIndexChanging1" 
              ...
              PageSize="8" HorizontalAlign="Left" AllowPaging="True" DataKeyNames ="WId" 
              ForeColor="#333333" GridLines="None">
              <Columns>
                  <asp:BoundField DataField="WId" Visible="False" />
                  <asp:BoundField DataField="Number" HeaderText="仓库编号" />
                  <asp:BoundField DataField="Name" HeaderText="仓库名称" />
                  <asp:HyperLinkField DataNavigateUrlFields="WId" DataNavigateUrlFormatString="UpdateWarehouse.aspx?ID={0}"
