<%@ Page Language="C#" AutoEventWireup="true" Inherits="AddReceivingUnit" Codebehind="AddReceivingUnit.aspx.cs" %>
...
<table border="1" align="center" cellpadding="5" cellspacing="1" bgcolor="#eeeeee" style="width: 100%">
  ...
  <tr bgcolor="#a4a4a4">
    <td colspan="2" style="height: 10px"><div align="center">
        <strong><span class="style3">添加收货单位</span></strong>（<span class="style4">带*号的信息必需填写</span>）</div></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2" >
        名&nbsp;&nbsp;&nbsp;&nbsp; 称：<asp:TextBox ID="TextBox2" runat="server"></asp:TextBox><span class="STYLE1">*</span><span
            > &nbsp; &nbsp;</span></td>
  ...
  <tr align="center">
   ...
   <tr align="left">
    <td colspan="2" bgcolor="#FFFFFF" style="height: 10px" class="style5">
    提示：请输入有效的数字&nbsp;</td>
  </tr></table></div>
