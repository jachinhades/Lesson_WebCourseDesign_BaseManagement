<%@ Page Language="C#" AutoEventWireup="true" Inherits="OutWarehouseStatistics" Codebehind="OutWarehouseStatistics.aspx.cs" %>
...
<table width="100%" border="1" align="center" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
    ...
    <td height="10" bgcolor="blue" style="width: 59%"><div align="center" 
            class="style1"><strong style="font-size: medium">产品出库管理</strong></div></td>
  </tr>
</table>
<table width="100%" border="1" align="center" cellpadding="5" cellspacing="0">
    <tr>
      ...
      OnPageIndexChanging="GridView1_PageIndexChanging1" 
              ...
              DataKeyNames ="OId" ForeColor="#333333" GridLines="None">
              <Columns>
...
<table border="1" align="center" cellpadding="3" cellspacing="1" style="width: 100%">
    ...
    <tr align="left" >
        <td bgcolor="#ffffff" colspan="5" style="width: 80%; height: 21px;" 
            class="style2">
            请输入时间： <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button2"
                runat="server" Text="产品出库年度统计" OnClick="Button2_Click" Width="158px" />
            </td>
    </tr>
