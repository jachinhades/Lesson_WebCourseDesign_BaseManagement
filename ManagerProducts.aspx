<%@ Page Language="C#" AutoEventWireup="true" Inherits="ManagerProducts" Codebehind="ManagerProducts.aspx.cs" %>
...
<table width="100%" border="1" align="center" cellpadding="5" cellspacing="1">
     <tr>
    <td height="10" bgcolor="blue" style="width: 59%">
        <div align="center" class="style1" 
         ><strong style="color: #FFFFFF">产品管理</strong></div></td>
  </tr>
</table>
    ...
    <tr>
      ...
      OnPageIndexChanging="GridView1_PageIndexChanging1" 
              ...
              <Columns>
                  ...
                  <asp:BoundField DataField="Warehouse" HeaderText="产品存放仓库" />
                  <asp:BoundField DataField="InPrice" HeaderText="产品入库单价" />
                  <asp:BoundField DataField="OutPrice" HeaderText="产品出库单价" />
                  <asp:BoundField DataField="Original" HeaderText="产品原始库存" />
                  <asp:BoundField DataField="LowLine" HeaderText="产品库存下限" />
                  <asp:BoundField DataField="UpLine" HeaderText="产品库存上限" />
                  <asp:BoundField DataField="HId" Visible="False" />
                  <asp:HyperLinkField DataNavigateUrlFields="HId" DataNavigateUrlFormatString="UpdateProductInfo.aspx?ID={0}"
